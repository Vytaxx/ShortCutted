...
# Context
The point behind ShortCutted is that if you're someone like me who doesn't like cluttered bookmarks at the top of your browser, you can use ShortCutted to find shortcut groups. But while I programming ShortCutted I thought, what if I make it so that anyone can upload their own public shortcut group for anyone to use.
